...
\author{\begin{tabular}{cp{2cm}c} Jean-Alix \textsc{David} & & Kilian \textsc{Demeulemeester} \\ \texttt{jadavid@kth.se} & & \texttt{kiliande@kth.se} \end{tabular}}
