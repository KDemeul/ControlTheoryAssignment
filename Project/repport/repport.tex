...
\input{part/modeling/modeling}

\input{part/manualControl/manualControl}
 
% \section{Calculation of controllers}
% 
% \setcounter{subsection}{1}
% \input{part/calculationOfControllers/exercise311}
% \setcounter{subsection}{-1}
% 
% \section{Laboratory occasion 2}
% 
% \input{part/decentralizedControl/decentralizedControl}
% 
% \input{part/robustControl/robustControl}
% 
